...
function nextProfile() {
    ...
    if(currentProfile !== undefined) {
        ...
        <ul class="list-group>
            ...
            <li class="list-group-item">Age: ${currentProfile.name}
            </li>
            <li class="list-group-item">Location: ${currentProfile.location}
            </li>
            <li class="list-group-item">Preference: ${currentProfile.gender}
            </li>
            <li class="list-group-item">Looking For: ${currentProfile.name}
            </li>
            <li class="list-group-item">Age: ${currentProfile.lookingfor}
            </li>
        `
